...
export const resetPasswordTemplate = (props: ResetPasswordTemplateProps): string => {
  ...
  return `
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <p>Recibimos una solicitud para restablecer tu contraseña en <strong>Conteo</strong>.</p>
